...
const styles = StyleSheet.create({
  ...
  // Nous estils per layout compacte
  campaignContainerCompact: {
    backgroundColor: Colors.white,
    flexDirection: 'row',
    padding: Spacing.sm,
    borderBottomWidth: 1,
  ...
  galleryButtonTextSmall: {
    color: Colors.primary,
    fontSize: FontSizes.sm,
  },
  participationsButtonSmall: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: Colors.secondary,
