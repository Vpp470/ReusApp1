...
const styles = StyleSheet.create({
  ...
  description: { fontSize: FontSizes.sm, color: Colors.darkGray, marginBottom: Spacing.md },
  statsRow: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: Spacing.md,
  ...
  statText: { fontSize: FontSizes.sm, color: Colors.darkGray },
  dateRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.xs, marginBottom: Spacing.md },
  dateText: { fontSize: FontSizes.sm, color: Colors.gray },
  actionsRow: {
    flexDirection: 'row',
  ...
  hint: { fontSize: FontSizes.xs, color: Colors.gray, marginTop: Spacing.xs },
