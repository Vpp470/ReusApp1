...
const styles = StyleSheet.create({
  ...
  statLabel: { fontSize: FontSizes.xs, color: Colors.gray },
  tabsContainer: {
    flexDirection: 'row',
    backgroundColor: Colors.white,
    borderBottomWidth: 1,
  ...
  tabText: { fontSize: FontSizes.sm, color: Colors.gray },
  activeTabText: { color: Colors.primary, fontWeight: '600' },
  content: { flex: 1, padding: Spacing.md },
  sectionTitle: { fontSize: FontSizes.lg, fontWeight: 'bold', color: Colors.textDark, marginBottom: Spacing.xs },
  sectionHint: { fontSize: FontSizes.sm, color: Colors.gray, marginBottom: Spacing.md },
  qrCard: {
    backgroundColor: Colors.white,
  ...
  qrEstablishment: { fontSize: FontSizes.md, fontWeight: '600', color: Colors.textDark },
  qrHint: { fontSize: FontSizes.sm, color: Colors.gray },
  ...
  qrCodeText: { flex: 1, fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace', fontSize: FontSizes.sm },
  scanCount: { fontSize: FontSizes.xs, color: Colors.gray, marginTop: Spacing.xs },
  emptyTab: { alignItems: 'center', paddingVertical: Spacing.xl },
  emptyText: { color: Colors.gray, marginTop: Spacing.sm },
  participantCard: {
    backgroundColor: Colors.white,
    borderRadius: BorderRadius.md,
    padding: Spacing.md,
  ...
  participantName: { fontSize: FontSizes.md, fontWeight: '600', color: Colors.textDark },
  participantEmail: { fontSize: FontSizes.sm, color: Colors.gray },
  ...
  raffleName: { fontSize: FontSizes.md, fontWeight: '600', color: Colors.textDark },
  raffleEmail: { fontSize: FontSizes.sm, color: Colors.gray },
  raffleDate: { fontSize: FontSizes.xs, color: Colors.gray, marginTop: Spacing.xs },
  ...
  modalTitle: { fontSize: FontSizes.lg, fontWeight: 'bold', color: Colors.textDark },
  ...
  input: { backgroundColor: Colors.background, borderRadius: BorderRadius.md, padding: Spacing.md, fontSize: FontSizes.md },
  ...
  cancelButtonText: { color: Colors.gray },
