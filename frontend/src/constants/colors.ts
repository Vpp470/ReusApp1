// Colores oficiales de REUS COMERÇ i FUTUR - Estilo web elegant
export const Colors = {
  // Colores corporativos principales - Verde metálico suave
  ...
  // Colores base
  background: '#2D4A40',   // Fondo verde oscuro suave metálico
  backgroundLight: '#3D5A50',
  white: '#FFFFFF',
  black: '#000000',
  ...
  // Efectos glassmorphism - Ahora con fondo claro
  glassBackground: 'rgba(255, 255, 255, 0.95)', // Fondo blanco semi-transparente
  glassBorder: 'rgba(61, 122, 95, 0.2)',
  
  // Cards y superficies - Siempre claras
