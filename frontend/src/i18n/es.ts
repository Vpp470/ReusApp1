export default {
  ...
  consell: {
    ...
    welcome: 'Bienvenido al Consejo',
    welcomeText: 'Acceso exclusivo para miembros del consejo rector de REUS COMERCIO y FUTURO',
    agenda: {
      title: 'Agenda de Actos Institucionales',
      description: 'Visualiza la agenda y miembros asistentes',
    ...
    assumptes: {
      title: 'Asuntos Sobrevenidos',
      description: 'Gestión de asuntos urgentes',
      noItems: 'No hay asuntos pendientes',
      addItem: 'Añadir Asunto',
      priority: 'Prioridad',
    ...
    campanyes: {
      title: 'Campañas Futuras',
      description: 'Planificación de campañas',
      noItems: 'No hay campañas planificadas',
      addItem: 'Añadir Campaña',
      manager: 'Gestor',
    ...
    comptes: {
      ...
      noItems: 'No hay documentos',
      addItem: 'Añadir Documento',
      period: 'Período',
      comments: 'Comentarios',
      download: 'Descargar',
    },
    publicitaries: {
      title: 'Campañas Publicitarias Contratadas',
      description: 'Gestión de campañas en curso',
      noItems: 'No hay campañas',
      addItem: 'Nueva Campaña',
      media: 'Medio',
      budget: 'Presupuesto',
    ...
    actes: {
      ...
      description: 'Consulta la última acta aprobada',
      noItems: 'No hay actas',
      addItem: 'Subir Nueva Acta',
      lastActa: 'Última Acta',
      meetingDate: 'Fecha de la Reunión',
      downloadActa: 'Descargar Acta',
      uploadedBy: 'Subido por',
      history: 'Historial de Actas',
    },
  },
