export default {
  ...
  consell: {
    ...
    welcome: 'Benvingut al Consell',
    welcomeText: 'Accés exclusiu per a membres del consell rector de REUS COMERÇ i FUTUR',
    agenda: {
      title: 'Agenda dels Actes Institucionals',
      description: 'Visualitza l\'agenda i membres assistents',
      noEvents: 'No hi ha esdeveniments aquest mes',
      addEvent: 'Afegir Esdeveniment',
      eventTitle: 'Títol de l\'esdeveniment',
      location: 'Ubicació',
      time: 'Hora',
      attendees: 'Assistents',
      confirmAttendance: 'Confirmar Assistència',
      cancelAttendance: 'Cancel·lar Assistència',
      attending: 'Assistiré',
      notAttending: 'No assistiré',
    },
    assumptes: {
      title: 'Assumptes Sobrevinguts',
      description: 'Gestió d\'assumptes urgents',
      noItems: 'No hi ha assumptes pendents',
      addItem: 'Afegir Assumpte',
      priority: 'Prioritat',
    ...
    campanyes: {
      title: 'Campanyes Futures',
      description: 'Planificació de campanyes',
      noItems: 'No hi ha campanyes planificades',
      addItem: 'Afegir Campanya',
      manager: 'Gestor',
      startDate: 'Data d\'inici',
      endDate: 'Data de fi',
    },
    comptes: {
      title: 'Estat de Comptes',
      description: 'Situació financera',
      noItems: 'No hi ha documents',
      addItem: 'Afegir Document',
      period: 'Període',
      comments: 'Comentaris',
      download: 'Descarregar',
    },
    publicitaries: {
      title: 'Campanyes Publicitàries Contractades',
      description: 'Gestió de campanyes en curs',
      noItems: 'No hi ha campanyes',
      addItem: 'Nova Campanya',
      media: 'Mitjà',
      budget: 'Pressupost',
      totalBudget: 'Pressupost total',
    },
    actes: {
      title: 'Actes del Consell',
      description: 'Consulta l\'última acta aprovada',
      noItems: 'No hi ha actes',
      addItem: 'Pujar Nova Acta',
      lastActa: 'Última Acta',
      meetingDate: 'Data de la Reunió',
      downloadActa: 'Descarregar Acta',
      uploadedBy: 'Pujat per',
      history: 'Historial d\'Actes',
    },
  },
